...
# twitch
CLIENT_ID = "6ezkh5z5x1p812zmvhrhyq322okmgj"  # Twitch Client ID
OAUTH_TOKEN = "7ghrmvh21junsrishn6o14zgujkf49"  # Twitch OAuth Token
PERIOD = 0  # how many hours since the clip's creation should've passed e.g. 24, 48 etc 0 for all time
LANGUAGE = "en"  # en, es, th etc.
LIMIT = 2  # 1-100


# selenium
ROOT_PROFILE_PATH = r"C:\Users\samyi\AppData\Roaming\Mozilla\Firefox\Profiles\6v2rywrl.default-release"  # Path to the Firefox profile where you are logged into YouTube
...
RESIZE_CLIPS = False  # Resize clips to fit RESOLUTION (True/False) If any RESIZE option is set to False the video might end up having a weird resolution
